      ...
      home: Builder(
        builder: (context) {
          return Center(
            child: Column(
              children: [
                const Align(alignment: Alignment.topRight, child: Text("Родителям", style: TextStyle(color: Colors.amber, fontSize: 16))),
                const Text("Karmaнные", style: TextStyle(fontSize: 44)),
                Material(
                  child: TextField(
